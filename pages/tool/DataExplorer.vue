      ...
      v-layout(row wrap)
        v-flex(lg12)
          ...
          v-card.pa-4.grey.lighten-4.card--raised
            ...
            v-select(
              label="Variable for circle size"
              autocomplete
              dense
              :items="varsArr"
              v-model="radiusVar"
            ...
            v-select(
              label="Variable for circle color"
              autocomplete
              dense
              :items="varsArr"
              v-model="colorVar"
            ...
            v-select(
              label="Variable for map circle size"
              autocomplete
              dense
              :items="varsArr"
...
export default {
  data() {
    return {
      ...
      xAxis: Function,
      yAxis: Function,
      filepath: '/data/data_explorer.csv',
  ...
  mounted() {
    getParsedData('/data/data_explorer.csv').then((data) => {
